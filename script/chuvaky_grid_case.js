  ...
  function chuvakyGridMaker() {
    var chuvaky_container_grid = '<a class="chuvaky_gif_link" id="chuvaky">';
    chuvaky_container_grid += `<img src="${path_1}" class="chuvaky_gif_img_2" id="chuvaky_gif_1">`;
    chuvaky_container_grid += `<img src="${path_2}" class="chuvaky_gif_img_2" id="chuvaky_gif_2"></a><a class="chuvaky_gif_link">`;
    chuvaky_container_grid += `<img src="${path_3}" class="chuvaky_gif_img_2" id="chuvaky_gif_3">`;
    chuvaky_container_grid += `<img src="${path_4}" class="chuvaky_gif_img_2" id="chuvaky_gif_4"></a>`;

    // перевірка рєзолюшн екрану
    if (window.innerWidth >= 992) {
      chuvaky_container_grid = '<a class="chuvaky_gif_link" id="chuvaky">';
      chuvaky_container_grid += `<img src="${path_1}" class="chuvaky_gif_img" id="chuvaky_gif_1">`;
      chuvaky_container_grid += `<img src="${path_2}" class="chuvaky_gif_img" id="chuvaky_gif_2">`;
      chuvaky_container_grid += `<img src="${path_3}" class="chuvaky_gif_img" id="chuvaky_gif_3">`;
      chuvaky_container_grid += `<img src="${path_4}" class="chuvaky_gif_img" id="chuvaky_gif_4"></a>`;
    }
